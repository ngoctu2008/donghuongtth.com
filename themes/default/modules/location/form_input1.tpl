...
<div class="row location-row">
	...
	<div class="col-md-24 province">
	<input type="hidden" name="khac" value="1"/>
	<label for="birthday" class="control-label col-md-6 text-normal">{LANG.province}</label>
	<div class="col-md-18">
	...
	<div class="col-md-24 m-bottom district">
	<label for="birthday" class="control-label col-md-6 text-normal">{LANG.district}</label>
	<div class="col-md-18">
		<select class="form-control"
