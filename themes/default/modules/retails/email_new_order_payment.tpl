    ...
    <div style="width: 700px; padding: 16px; margin: 0 auto;">
        ...
        border-radius: 4px;padding: 24px 16px;">
            ...
            <h1
                ...
                THÔNG BÁO ĐƠN HÀNG MỚI</h1>
            <div>
                <p>Chào shop <span style="font-weight: 700;">{SHOP_NAME},</span> </p>
                <p style="margin: 0;">Shop vừa có đơn hàng mới với thông tin như sau: </p>
            </div>
            <div style="border-top:1px solid #DADADA;margin-top: 20px;">
                ...
                <span>Địa chỉ : {info_order.address}</span>
            </div>
            <!-- BEGIN: data_product -->
        ...
        border-top: 1px solid #dadada;">
            ...
            <div style="margin-bottom: 30px;margin-top: 15px;">
                <span style="color: #E03C00;">*</span>Vui lòng đăng nhập vào tài khoản của bạn trên website <a href="https://banhang.chonhagiau.com/" style="color: #E1A208;">banhang.chonhagiau.com</a> và xác nhận đơn hàng.
