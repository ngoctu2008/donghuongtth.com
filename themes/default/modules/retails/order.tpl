...
<div class="container_payment">
    ...
    <div class="payment_address bg_white rounded-lg p-4 my-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-1 col-md-2 text-center"><button class="btn_none secondary_text ml-3"
                    id="change_address">Thay đổi</button></div>
        </div>
    ...
    <div class="payment_addressChange bg_white rounded-lg p-4 my-3 {address_other}">
        ...
        <div class="payment_addressChange_item d-flex">
            ...
            <div class="fs_16 d-flex">
                <p id="address_name_ing">{ADDRESS.name}</p>
        ...
        <div class="payment_addressChange_save mt-3">
            ...
            <div class="row mt-4">
                ...
                <a href="{LINK_ADDRESS}" class="col-lg-1 col-md-2 text-center secondary_text">Thay đổi</a>
            </div>
    ...
    <script>
        ...
        $('.botton_add_address').click(function() {
            $.post(nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' +
                nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable +
                '=order&mod=add_address_ajax',
                function(res) {
    ...
    <div class="payment_listProduct bg_white my-2 pb-2 pt-3 px-4">
            ...
            <div class="row d-flex pl-lg-3 pl-md-0 align-items-center">
                <div class="col-md-1 ">
                    <a class="d-flex justify-content-center align-items-center w-100 h-100"
                        href="{LOOP_INFO_PRODUCT.alias}"><img src="{LOOP_INFO_PRODUCT.image}" alt=""
        ...
        <div class="row align-items-center">
            ...
            <div class="w-100 position-relative">
                ...
                <div class="modal fade p-1" data-toggle="modal"
                    style="position: absolute;top:6px;right:-18px;left:none;height: initial;left: initial;width: 360px;"
        ...
        <script>
            ...
            if (giatri["status"] == 1) {
                content +=
                    '<div class="mb-3 coupons_voucher_wallet rounded d-flex " style="height:100px;background:#fdf8eb">';
            } else {
                ...
                <div class="col-md-4 border-right pt-3 px-3">
                    ...
                    <form action="" id="add_address">
                        <div class="input-group mb-4 border rounded-lg p-1 input_ecng">
                            <input id="note_product_{info_store.id}_{key_warehouse}" type="text"
                                placeholder="Ghi chú cho cửa hàng" name="" aria-describedby="button-addon4"
                ...
                <div class="col-md-8">
                    <div class="row d-flex px-3 pt-4 align-items-center">
                        ...
                        <div class="col-md-5" id="text_phivanchuyen_{info_store.id}_{key_warehouse}">
                            <p class="mb-0" id="method_transfer_{info_store.id}_{key_warehouse}"><i
                        ...
                        <div class="col-md-2 secondary_text">
                            ...
                            <input class="hidden transporter_store_active"
                                id="transporter_first_{info_store.id}_{key_warehouse}" value="{transporter_first}" />đ
                        </div>
                        <script>
                            $(document).ready(function() {
                        ...
                        <p>Đơn hàng này của bạn đã vượt mức cho phép về khối lượng và kích thước không thể vận chuyển
                        </p>
    ...
    <div class="payment_total bg_white my-2">
                    ...
                    <tbody>
                        <tr>
                            <td class="text_gray_color">
                                Tạm tính
                                <input hidden="" type="number" name="total_merchandise" id="total_merchandise"
                                    value="{total}">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="float-right"><span id="tongphivanchuyen"><i class="fa fa-spinner fa-spin"
                                        aria-hidden="true"></i></span>đ</td>
                        </tr>
                        <tr class="row_voucher">
                            <td class="text_gray_color">Voucher</td>
                            <td class="float-right">- <span id="tongvoucher"><i class="fa fa-spinner fa-spin"
                                        aria-hidden="true"></i></span>đ</td>
                        </tr>
                        <tr>
                            <td class="mb-0">Tổng thanh toán</td>
                            <td class="float-right fs_20 secondary_text mb-0"><span
                                    id="tongtienchinhxac">{total_format}</span>đ</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row p-4 align-items-center">
            <div class="col-md-9">
                <div class="primary_text">Khi nhấn hoàn tất đồng nghĩa bạn đã kiểm tra kỹ đơn hàng và đồng ý với <a
                        class="secondary_text" title="Các điều khoản của ECNG"
                        href="https://chonhagiau.com/ecng/quy-dinh-va-hinh-thuc-thanh-toan.html" target="_blank">các
                        điều khoản của ECNG</a></div>
                <div class="fw_500 primary_text pt-2">Khi bạn thanh toán đơn hàng là bạn đã ủng hộ <span
                        style="color:#1358B9">{children_fund}</span> vào quỹ “ <span class="secondary_text">QUỸ BẢO TRỢ
                        TRẺ EM VIỆT NAM</span> ”</div>
            </div>
            <div class="col-md-3 text-right">
                <button id="button-payment-method" class="btn_ecng_lg" onclick="order_product_check_out()">Hoàn tất đơn
                    hàng</button>
            </div>
        </div>
    </div>
            ...
            transporter_store.forEach((element, index) => {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            if (Number(res) == -1) {
                                load_data_tranposter_next(store_id, warehouse_id, element.id, element
                                    .name_transporters, element.description, 'Quá giới hạn cân nặng');
                            } else {
                                load_data_tranposter_next(store_id, warehouse_id, element.id, element
                                    .name_transporters, element.description, format_number(Number(res)));
                            }
                    ...
                    success: function(res) {
                        ...
                        if (Number(res.fee) == -1) {} else {
                            if (Number(res.fee) == 0) {
                                ...
                                load_data_tranposter_next(store_id, warehouse_id, element.id, element
                                    .name_transporters, element.description, format_number(Number(res.fee)));
