<?php
	...
	*/
	...
	//  đơn hàng thành công gửi email về seller
	function email_order_delivered_seller($data_order, $data_pro, $info_order)
	{ 
		global $module_info, $lang_module, $module_file, $pro_config, $global_config, $money_config, $db;
		
		$xtpl = new XTemplate("email_order_delivered_seller.tpl", NV_ROOTDIR . "/themes/" . $global_config['module_theme'] . "/modules/" . $module_file);
	...
	//  đơn hàng thành công gửi email về khach
	function email_order_delivered_khach($data_order, $data_pro, $info_order)
	{ 
		global $module_info, $lang_module, $module_file, $pro_config, $global_config, $money_config, $db;
