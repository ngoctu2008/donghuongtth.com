...
function nv_write_lang_mod_admin($mod, $lang, $arr_new_lang, $setfunction)
{
    ...
    if (!empty($arr_new_lang)) {
        ...
        if (file_exists(NV_ROOTDIR . '/modules/' . $mod . '/language/' . $file_name . $lang . '.php')) {
            ...
            $content_lang = "<?php\n\n";
            $content_lang .= "/**\n";
            $content_lang .= "* @Project TMS HOLDINGS\n";
            $content_lang .= "* @Author TMS HOLDINGS <contact@tms.vn>\n";
            $content_lang .= "* @Copyright (C) " . date("Y") . " TMS HOLDINGS. All rights reserved\n";
            ...
            $content_lang .= "\$lang_translator['author'] = 'TMS Holdings (contact@tms.vn)';\n";
            $content_lang .= "\$lang_translator['createdate'] = '" . date('d/m/Y, H:i') . "';\n";
            $content_lang .= "\$lang_translator['copyright'] = 'Copyright (C) " . date('Y') . " TMS Holdings. All rights reserved';\n";
