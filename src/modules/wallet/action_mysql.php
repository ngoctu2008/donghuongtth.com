...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $module_data . "_bank_acount";
...
$sql_drop_module[] = "DROP TABLE IF EXISTS " . $db_config['prefix'] . "_" . $module_data . "_withdrawal";
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_bank_acount(
  id int(11) NOT NULL AUTO_INCREMENT,
  acount_userid int(11) NOT NULL,
  acount_cccd varchar(250) NOT NULL,
  acount_date_range varchar(250) NOT NULL,
  acount_issued_by varchar(250) NOT NULL,
  acount_name varchar(250) NOT NULL,
  acount_number varchar(250) NOT NULL,
  acount_bankid int(11) NOT NULL,
  acount_bankbranch text NOT NULL,
  user_add int(11) NOT NULL,
  time_add int(11) NOT NULL,
  user_edit int(11) DEFAULT NULL,
  time_edit int(11) DEFAULT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_ipn_logs(
  id int(11) NOT NULL AUTO_INCREMENT,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_transaction(
  ...
  money_fees int(11) DEFAULT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_transfers(
  id int(11) NOT NULL AUTO_INCREMENT,
  transaction_id int(11) DEFAULT NULL,
  customer_name varchar(250) NOT NULL,
  customer_email varchar(250) NOT NULL,
  customer_phone varchar(250) NOT NULL,
  receiver_userid varchar(250) NOT NULL,
...
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_withdrawal(
  id int(11) NOT NULL AUTO_INCREMENT,
  transaction_id int(11) DEFAULT NULL,
  userid int(11) NOT NULL,
  acount_cccd varchar(250) NOT NULL,
  acount_date_range text NOT NULL,
  acount_issued_by text NOT NULL,
  acount_name varchar(250) NOT NULL,
  acount_number varchar(250) NOT NULL,
  acount_bankid varchar(250) NOT NULL,
  acount_bankbranch varchar(250) NOT NULL,
  weight smallint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (id)
=======
$sql_create_module[] = "CREATE TABLE " . $db_config['prefix'] . "_" . $module_data . "_admin_groups(
...
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . "(lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'minimum_amount', 'a:1:{s:3:"VND";s:52:"50000,200000,500000,1000000,2000000,5000000,10000000";}')";
...
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . "(lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'allow_exchange_pay', '0')";
...
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . "(lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'transfer_fees', '3500')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . "(lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'minimum', '50000')";
$sql_create_module[] = "INSERT INTO " . NV_CONFIG_GLOBALTABLE . "(lang, module, config_name, config_value) VALUES ('" . $lang . "', '" . $module_name . "', 'withdrawal_fees', '11000')";
