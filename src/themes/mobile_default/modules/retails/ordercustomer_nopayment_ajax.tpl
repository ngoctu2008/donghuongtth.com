...
<!-- BEGIN: loop -->
<div class="history bg_white px-3 my-1">
	<div class="history_header d-flex justify-content-between border-bottom align-items-center  py-2 mb-3">
		<div class="history_header_shop" style="width: 67%">
			<a class="d-flex align-items-center" title="{VIEW.store_name}" href="{VIEW.alias_shop}">
				<div class="beauty_img" style="width: 30px; height: 30px;">
					<img class="max_w_h rounded-circle" src="{VIEW.avatar_image_store}" class="rounded"  alt="">
				</div>
				<span class="ml-3"> {VIEW.store_name}</span>
			</a>
		</div>
		<span href="#" class="secondary_text pt-1">{VIEW.order_status}</span>
	</div>
	...
	<div class="history_product border-bottom pb-2">
		...
		<div class="row d-flex align-items-center py-2">
			<div class="col-md-3 col-3 col-xl-1">
			...
			<div class="col-md-5 col-5 col-xs-7">
			...
			<div class="col-md-1 col-1 col-xl-2 text-center">
				x {product.quantity}
			</div>
			<div class="col-md-3 col-3 col-xl-2 secondary_text text-center">{product.price} đ</div>
		</div>
		<!-- END: product -->
	</div>
	<div class="history_option text-right py-3">
		...
		<!-- BEGIN: rate -->
		<button class="btn_ecng mr-3" data-toggle="modal" data-target="#cmt_product{VIEW.id}">Đánh giá</button>
	...
	<!-- BEGIN: repayment -->
	<div class="total_repayment text-right fs_18 bg_white p-3 mb-3">
		<div class="total_price_repayment secondary_text my-2">{total_payment} đ</div>
...
<div class="clear"></div>
<!-- BEGIN: generate_page -->
		<nav class="text-center d-flex justify-content-center pagi_wishlist">
			{NV_GENERATE_PAGE}
		</nav>
<!-- END: generate_page -->
