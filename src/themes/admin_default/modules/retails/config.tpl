		...
		<table class="table table-striped table-bordered table-hover full">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input class="form-control" type="text" value="{DATA.number_product_push}" name="number_product_push"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input class="form-control" type="text" value="{DATA.time_push_product}" name="time_push_product"/>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<input class="form-control" type="text" value="{DATA.raw_product_prefix}" name="raw_product_prefix"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input class="form-control" type="text" value="{DATA.raw_order_prefix}" name="raw_order_prefix"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input class="form-control" type="text" value="{DATA.raw_import_product_prefix}" name="raw_import_product_prefix"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input class="form-control" type="text" value="{DATA.percent_of_order_payment_discount}" name="percent_of_order_payment_discount"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="address_ecng" placeholder="Nhập địa chỉ" value="{DATA.address_ecng}" class="form-control bg-none border-0 " required="required">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="insurance" value="{DATA.insurance}" class="form-control bg-none border-0 " required="required">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="voucher_maximum_percent" value="{DATA.voucher_maximum_percent}" class="form-control bg-none border-0 " required="required">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="children_fund" value="{DATA.children_fund}" class="form-control bg-none border-0 " required="required">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="email_get_not_received" value="{DATA.email_get_not_received}" class="form-control bg-none border-0 " required="required">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="email_order_seller_delivery_failed" value="{DATA.email_order_seller_delivery_failed}" class="form-control bg-none border-0 " required="required">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="email_seller_register" value="{DATA.email_seller_register}" class="form-control bg-none border-0 " required="required">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input class="form-control" type="password" value="{DATA.website_code_vnpay}" name="website_code_vnpay"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input class="form-control" type="password" value="{DATA.checksum_vnpay}" name="checksum_vnpay"/>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<p>
							<select class="form-control" onchange="get_form_nha_ban()" id="form_nha_ban" name="form_nha_ban">
								<!-- BEGIN: form_nhaban -->
