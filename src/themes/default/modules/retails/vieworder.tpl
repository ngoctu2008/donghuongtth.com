		...
		<div class="viewOrder_header d-flex justify-content-between border-bottom  py-2 mb-3">
			<div class="viewOrder_header_shop">
				<a href="{info_store.alias_shop}">
					<img src="{info_store.avatar_image}" class="rounded-circle" style="width: 25px; height: 25px;object-fit: contain;" alt="">
		...
		<div class="history_product border-bottom pb-2">
			...
			<div class="row d-flex align-items-center py-2">
				<div class="col-md-2 col-xl-1">
					<a class="width_80 beauty_img" href="{VIEW.alias_product}"><img src="{VIEW.image}" class="max_w_h" alt=""></a>
				</div>
				<div class="col-md-7">
...
<script>
	$(document).ready(function(){
		if($('.info_order div.d-flex.justify-content-between p.fs_18 span').last().text() == 'Thanh toán thất bại'){
