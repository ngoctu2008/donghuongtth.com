...
if (!nv_function_exists('nvb_landing_product_suggest')) {
	/**
	* @param string $module
	...
	* @return string
	*/
	function nvb_config_landing_product_suggest($module, $data_block, $lang_block)
	{
	...
	* @return number
	*/
	function nvb_config_landing_product_suggest_submit($module, $lang_block)
	{
		global $nv_Request;
	...
	* @return string
	*/
	function nvb_landing_product_suggest($block_config)
	{
		...
		if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $block_config['module'] . '/global.product_suggest.tpl')) {
			$block_theme = $global_config['module_theme'];
		} elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $block_config['module'] . '/global.product_suggest.tpl')) {
		...
		$xtpl = new XTemplate('global.product_suggest.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $block_config['module']);
...
if (defined('NV_SYSTEM')) {
	$content = nvb_landing_product_suggest($block_config);
}
