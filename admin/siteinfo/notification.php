    ...
    if (isset($admin_mods[$data['module']]) or isset($site_mods[$data['module']])) {
        ...
        if ($data['module'] == 'retails') {
            if ($data['type'] == 'listorder') {
                ...
                $data['link'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $data['module'] . '&amp;' . NV_OP_VARIABLE . '=listorder&store_id='.$data['send_to'];
            }else if($data['type'] == 'require'){
                $data['title'] = $data['content'];
                $data['link'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $data['module'] . '&amp;' . NV_OP_VARIABLE . '=seller_management';
            }else if($data['type'] == 'registercontact'){
                $data['title'] = $data['content'];
                $data['link'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $data['module'] . '&amp;' . NV_OP_VARIABLE . '=registercontact';
            }else if($data['type'] == 'order'){
                $data['title'] = $data['content'];
                $data['link'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $data['module'] . '&amp;' . NV_OP_VARIABLE . '=view_order&id=' . $data['obid'];
            }
			else if($data['type'] == 'complain'){
                $data['title'] = $data['content'];
                $data['link'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $data['module'] . '&amp;' . NV_OP_VARIABLE . '=listorder';
            }
        }
